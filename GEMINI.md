# Gemini AGENTS.md — Cognitive OS v3.0 (Google-Optimized)
...
## Gemini-Specific
- Use Gemini extensions: chrome-devtools-mcp, cloud-run, GeminiCloudAssist
- HuggingFace MCP for model discovery
- Stripe MCP for payment integration
- mcp-toolbox-for-databases for Google Cloud databases
